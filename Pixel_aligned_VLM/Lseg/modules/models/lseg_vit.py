...
#     # #     h = int(h.detach().cpu().numpy())
#     #     print(h.size())
#     #     h = h.size(0)
#     # if isinstance(w, torch.Tensor):
#     # #     w = int(w.detach().cpu().numpy())
#     #     print(w.size())
#     #     w = w.size(0)

#     # h = (h // pretrained.model.patch_size[1]) * pretrained.model.patch_size[1]
#     # w = (w // pretrained.model.patch_size[0]) * pretrained.model.patch_size[0]
...
#     # print(pretrained.model.patch_size[1], pretrained.model.patch_size[0])
#     # print(h, w)
...
#     #     nn.Unflatten(
#     #         2,
#     #         (int(h // pretrained.model.patch_size[1].item()), int(w // pretrained.model.patch_size[0].item()))  
#     #     )
#     # )
...
#     gs_old = torch.sqrt(torch.tensor(posemb_grid.size(0), dtype=torch.float32)).int().item()
...
#     nn.Unflatten(
#         2,
#         (int(h // pretrained.model.patch_size[1]), int(w // pretrained.model.patch_size[0]))  # 👈 튜플로 변환
#     )
# )
#     print('unflatten okay!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
...
def _resize_pos_embed(self, posemb, gs_h, gs_w):
    ...
    gs_old = int(math.sqrt(len(posemb_grid))) # 기존 코드
    # gs_old = int(math.sqrt(posemb_grid.shape[0]))  # 수정된 코드
    # gs_old = torch.sqrt(posemb_grid.shape[0].float()).int().item()
